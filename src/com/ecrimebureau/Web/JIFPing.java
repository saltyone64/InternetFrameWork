...
import com.ecrimebureau.Web.Entity.Ping;
 ...
 * @author e-Crime
 */
public class JIFPing extends javax.swing.JInternalFrame {
    ...
    private void jBPingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBPingActionPerformed
        ...
        System.out.println(jTFIP.getText());
                    ...
                    List<String> command = new ArrayList<>();
                       ...
                       command.add("-n");
                       command.add(jSpinnerN.getValue().toString());
                       command.add(jTFIP.getText().trim());
       
                     try{
                         Ping ping = new Ping(jTextArea1,command);
                         ping.begin();
                    }catch(Exception ex)
                    {
                        ex.printStackTrace();
